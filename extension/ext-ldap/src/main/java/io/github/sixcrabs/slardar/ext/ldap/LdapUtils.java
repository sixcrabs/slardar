package io.github.sixcrabs.slardar.ext.ldap;
...
public class LdapUtils {
    ...
    protected DirContext createDirContext(Properties properties) throws NamingException {
        DirContext ctx = null;
        try {
    ...
    public DirContext openConnection() throws Exception {
        initEnvironment();
        return InitialDirContext(props);
    }

    // connect to ldap server
    public DirContext createConnection() throws Exception {
        initEnvironment();
