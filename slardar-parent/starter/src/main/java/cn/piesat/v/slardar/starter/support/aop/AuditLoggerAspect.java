package cn.piesat.v.slardar.starter.support.aop;
...
import cn.piesat.v.slardar.starter.support.event.AuditLogEvent;
...
public class AuditLoggerAspect {
    ...
    @Pointcut("@annotation(cn.piesat.v.slardar.core.annotation.AuditLogger)") // 指定切入点为所有标记了注解的地方
