package org.winterfell.slardar.oauth.server.config;

import org.winterfell.slardar.oauth.server.OauthServerRequestFilter;
import org.winterfell.slardar.oauth.server.OauthServerRequestHandler;
...
public class SlardarOauthServerAutoConfiguration {
    ...
    @Bean
    public OauthServerRequestHandler requestHandler(OauthServerProperties serverProperties, SlardarContext context) {
