package io.github.sixcrabs.slardar.starter.support.aop;

import io.github.sixcrabs.slardar.core.annotation.AuditLogger;
...
import io.github.sixcrabs.slardar.starter.support.event.AuditLogEvent;
...
public class AuditLoggerAspect {
    ...
    @Pointcut("@annotation(io.github.sixcrabs.slardar.core.annotation.AuditLogger)") // 指定切入点为所有标记了注解的地方
